#ifndef KMR_STEERING_DATA_HPP__
#define KMR_STEERING_DATA_HPP__
...
** Defines
*****************************************************************************/
#define MAX_STEERING_DATA_SIZE (4) //derived from ST_GYRO_MAX_DATA_SIZE in firmware
...
class Steering : public packet_handler::payloadBase
{
public:
  Steering() : packet_handler::payloadBase(true, 2) {};
  struct Data {
    unsigned char followed_data_length;
    short data[MAX_STEERING_DATA_SIZE];
  } data;
